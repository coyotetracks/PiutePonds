...
<title>Piute Ponds Boilerplate</title>
<style type="text/css">
<!--
#apDiv2 {
	position:absolute;
...
<div class="rollover" id="apDiv3"><!-- #BeginLibraryItem "/Library/left-nav-buttons.lbi" -->
...
<!-- #EndLibraryItem --></div>
<div id="apDiv1">
  <p class="style3"><span class="style4"><span class="H1"><span id="heading1">Data Here:</span></span></span></p>
