...
<title>Piute Ponds Audubon Society</title>
...
<!-- #EndLibraryItem --></div>
<div id="apDiv1">
  <p class="style3"><span class="style4"><span class="H1"><span id="heading1">Autumn Supper</span></span></span></p>
  <p><span class="style9">We invited all of the members of Friends of Piute Ponds to a special walk aroundthe ponds followed by an evening of stories and information about the ponds. A wonderful time was had by all.</span></p>
  <p class="style9">This is an example of the benefits of being a member of Friends of Piute Ponds.</p>
  <p class="style9">We also gave gifts to all who attended: a special bag and mug personalized for our friends.</p>
  <p class="style9"><img src="images/bag-for-site-4in.png" width="288" height="225" alt=""/><img src="images/mug-for-site-3-in.png" width="216" height="234" alt=""/></p>
  <p class="style9">&nbsp;</p>
  <p class="style9">&nbsp;</p>
  <p class="style9">&nbsp;</p>
</div>
