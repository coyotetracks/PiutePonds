...
<div id="apDiv1">
  <p class="style3"><span class="style4"><span class="H1"><span id="heading1">Visit the Ponds</span></span></span></p>
  <p class="style9">Visitors  to Piute Ponds are encouraged.  The solitude and peace which one can  experience while visiting the ponds can reinvigorate and provide much needed  relief from the day to day stress of life.  Come and enjoy watching a  great blue heron glide effortlessly across the ponds, watch a black crowned  night heron down a frog, search for the elusive sora or extremely rare  occurrence of a tundra swan.  The area is perfect as a birding  destination, a photographic opportunity, hunting, educational laboratory, and  just walking.</p>
  <h1 align="left" class="style4">For Access to Piute Ponds</h1>
  <p align="left" class="style9">Go to the following link to request access to the Piute Ponds area:</p>
  <p align="left" class="style9"><a href="https://bsx.edwards.af.mil/piutepondsaccess" target="_blank">https://bsx.edwards.af.mil/piutepondsaccess</a></p>
  <p class="style9"><span class="style4"> Location:</span></p>
  <p class="style9"><img src="images/PIUTE_VICINITY_Map_For_Web.jpg" width="432" height="668" border="2" class="style3" /></p>
  <p class="style9">&nbsp;</p>
  <p class="style9">&nbsp;</p>
</div>
