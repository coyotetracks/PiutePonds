...
<div id="apDiv1">
  ...
  <p class="style9">Synopsis of overall resources with  links to Birds, Other Wildlife, Vegetation papers/pages<img src="images/Eastham's-Kit-Fox.jpg" alt="Kevin Eastham's Kit Fox" width="180" height="246" border="2" align="right" class="photo-caption" /></p>
  <p class="style9"> Below  (not underlined would be links) (see you taught me some more!)</p>
  <p class="style9"> Birds page:  photos of different birds observed at piute,  discussion of type, number of species of birds, interesting facts such as who nests  here, sensitive species that are found. For a .pdf file for general information <a href="PDFs/Birds-of-EAFB-Brochure.pdf" target="_blank">click here</a> (be patient please, the file is over 7 mb).</p>
  <p class="style9"> Other wildlife:  discussion on herps, invertebrates, mammals  (maybe links to different pages by wildlife type), photos of wildlife </p>
  <p class="style9">Vegetation:  discussion on plant communities at piute,  plant list posted here, photos of plants, plant map. For a .pdf of the plant list <a href="PDFs/Plant_list_Piute_Ponds_2009.pdf" target="_blank">click here</a>.</p>
  <p class="style9"> Water:  water source historical and present</p>
  ...
  <table width="670" border="0">
    <tr>
      <td colspan="3"><table width="670" border="0">
        ...
        <tr>
          <td colspan="3"><div align="center"><img src="images/Eastham-bob-cat-web-jul-07.jpg" alt="Bobcat July 2007 by Kevin Eastham" width="660" height="470" border="2" class="photo-caption" /></div></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
