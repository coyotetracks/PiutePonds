...
<!-- #EndLibraryItem --></div>
<div id="apDiv1">
  <p class="style3"><span class="style4"><span class="H1"><span id="heading1">Password Change Email Was Sent</span></span></span></p>
  
  The email with your new password was sent to the specified email address.
  Please login using this new password and change it.
  <p class="style9">&nbsp;</p>
</div>
