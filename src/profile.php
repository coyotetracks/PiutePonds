...
<title>Piute Ponds Profile Page</title>
...
<!-- #EndLibraryItem --><!-- #BeginLibraryItem "/Library/left-nav-buttons.lbi" -->
<p><!-- #BeginLibraryItem "/Library/left-nav-buttons.lbi" --><div class="rollover" id="buttons">
  <div class="rollover"><a href="index.php" class="rollover">HOME</a></div>
  <div class="rollover"><a href="history.php"> HISTORY OF<br>
    PIUTE PONDS</a></div>
...
<div id="apDiv1">
  ...
  <p align="left" class="style4">Profile</p>
  <?php
	$userInfo = getCurrentUserInfo();
	...
	if(isset($userInfo)) {
  ?>
  <p align="left" class="style9">This is your profile information.</p>
  <p align="left" class="style9">Make whatever changes you want.</p>
  <p align="left" class="style9">
		<form method='POST' action='php/profile_action.php'>
		<table>
		<tr>
		...
		<tr>
		<td class="style9">New Password:</td>
		<td><input type='password' name='password_1'></td>
		</tr>
		<tr>
		<td class="style9">Verify New Password:</td>
