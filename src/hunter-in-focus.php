...
<title>Piute Ponds Hunter in Focus</title>
...
<div class="style9" id="apDiv1">
  <h1 class="style3"><span class="style4"><span class="H1"><span id="heading1">Hunter In Focus</span></span></span></h1>
  <p>We don't have a hunter in focus write about at the moment, but contact Wanda if you want to be one.</p>
  <p>Otherwise, check back in August, we should have something by then.</p>
  <p>&nbsp;</p>
</div>
