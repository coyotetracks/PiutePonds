...
<div class="style9" id="apDiv1">
	...
	<table border='0'>
		...
		<tr>
			...
			<td colspan=4>Are you sure you want to delete this hunt?</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>
			<a href="php/remove_hunt_action.php?hunt_details_id=<?PHP echo $huntDetailsId ?>">Yes</a>
			</td>
			<td>
			<a href="HuntingHarvest.php">No</a>
			</td>
		</tr>
	</table>
