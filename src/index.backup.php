...
<div id="apDiv1">
  ...
  <p align="left" class="style4"><img src="images/egret_at_Piute_for-web.png" alt="egret at Piute Ponds" width="225" height="290" align="right" />Welcome</p>
  <p align="left" class="style9">The Piute Ponds Complex contains the largest freshwater marsh in Los Angeles County which supports a diversity of flora and fauna.&nbsp; A convergence of two mountain ranges (San Gabriel in the south and Tehacapi to the north), the Mojave Desert, coastal influence, and beneath the Pacific Flyway provides a mixing of a diverse suite of migratory birds.&nbsp; This area is unique within the Antelope Valley and provides a recreational resource for the surrounding communities.&nbsp; The Piute Ponds Complex is within a Significant Ecological Area (SEA) for Los Angeles County.&nbsp; An Alkali Mariposa Lily Conservation area bordering the Piute Ponds Complex has been included in the Draft West Mojave Plan. </p>
  <p align="left" class="style9"> In addition to its ecological value, Piute Ponds is recognized for its recreational and educational values.&nbsp; The largest recreational activities at Piute Ponds are bird watching and hunting for waterfowl.&nbsp; Currently the area is used consistently throughout the school year by Branch Elementary School as an outdoor laboratory.&nbsp; Other area schools use the area for educational purposes periodically through sponsored tours.&nbsp; </p>
  <p class="style9">Over 250 species of birds have been documented as using the Piute Ponds Complex.&nbsp; In 2004 the National Audubon Society designated the ponds as an &lsquo;Important Bird Area of California.&rsquo;&nbsp; The area is one of few areas in California that supports a successful White faced Ibis rookery.&nbsp; Black Crowned Night Herons and Great Blue Herons breed at the ponds regularly.&nbsp; Mr. Mike San Miguel documented the most southern extension breeding range of buffle head at Piute Ponds.</p>
